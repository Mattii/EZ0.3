...
const heroElement = {
  template: `
        ...
        <v-row no-gutters justify="space-around">
          ...
          >
            <template #sources>
              <source media="(max-width: 460px)" srcset="https://res.cloudinary.com/ddkef5waq/image/upload/v1700140505/enzapp/pricehero300_bureph.png">
            </template>
          <div class="px-9 pb-9 px-sm-12 pb-sm-12 h-100 ff-nunito d-flex align-end">
            <h2 class="text-h3 text-md-h3 text-lg-h2 ff-nunito">Cennik</h2>
          </div>
          </v-img>
          </v-col>
        </v-row>
